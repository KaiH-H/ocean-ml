...
for i in range(0,1356):
	...
	dh = open("/Users/brownscholar/Desktop/Internships/dates_1/dh_" + date + ".gr", "w+")
	density_times = open("//Users/brownscholar/Desktop/Internships/dates_1/density_" + date + ".gr", "w+")
	dh.write("\t30\n\t80\t27\n")
