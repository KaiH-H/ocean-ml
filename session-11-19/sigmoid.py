...
decision = "Should you go to sleep early?"

# Pick three factors that affect your decision and write them as strings
factor_1 = "Are you extremely tired?"
factor_2 = "Do you have a lot of homework?"
factor_3 = "Should you study for upcoming exams instead of sleeping"
...
# etc:
weights = np.array([4, -4, -2])#your code here
...
factor_values = np.array([1, 0, 1])# your code here
